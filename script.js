...
Repository.prototype.addBook = function(title, author, nrPages, read) {
    const book = new Book(title, author, nrPages, read);
...
function UI(repo) {
    ...
    this.populate = () => {
        this.repository.addBook("Ceva1", "Branza", 123, false);
        this.repository.addBook("Ceva2", "Costi", 20, true);
        this.repository.addBook("Ceva4", "Peleanca", 200, true);
    }
